      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Link to="/analyze">
              <Button size="lg" className="bg-primary hover:shadow-glow transition-all duration-300 text-lg px-8" onClick={lightTap}>
                Start Analysis
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
            <Link to="/feedback">
              <Button size="lg" variant="outline" className="text-lg px-8 border-primary/30 hover:bg-primary/10" onClick={lightTap}>
                Give Feedback
              </Button>
            </Link>
          </div>
